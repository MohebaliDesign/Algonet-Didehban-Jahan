...
| Geographic rendering surface                                | Highcharts Maps                                       | `WorldMap`                                                           | Accurate countries, choropleth, clustered points, corridors   | Documented exception: Highcharts renders geography; all surrounding controls use shadcn |
